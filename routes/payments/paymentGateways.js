...
router.post("/prices", (req, res) => {
    res.status(200).json({ "BasicPrice": 399, "StandardPrice": 699, "PremiumPrice": 899, "BasicPlanTime": 30, "StandardPlanTime": 60, "PremiumPlanTime": 90, "vpa": "q846296864@ybl", "payeeName": "Ganeshan Sudhakar" });
});
